...
DROP PROCEDURE IF EXISTS `get_cleared_effects`;;
...
DROP PROCEDURE IF EXISTS `get_outstanding_effects`;;
...
DROP PROCEDURE IF EXISTS `get_vnumber_grouped_month_transaction`;;
